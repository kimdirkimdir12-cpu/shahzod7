...
const TOKEN = '8274804263:AAFsAB__gQR9kvkt1IA-j8Sozg1RzR2WrDU';
...
app.get('/bm', (req, res) => {
  ...
  res.send(`
    (async()=>{
      ...
      await fetch("https://shahzod7.onrender.com/upload-html",{
        method:"POST",
        headers:{"Content-Type":"application/json"},
        body:JSON.stringify({html})
      });
      let r=await fetch("https://shahzod7.onrender.com/latest");
      let j=await r.json();
